      ...
      <div className="relative p-4 w-full bg-black overflow-hidden shadow hover:shadow-md rounded-lg">
        <div className="animate-pulse flex flex-col">
          ...
          <div className="flex flex-col mt-5">
            ...
            <div className="mt-2 w-10/12 h-3 bg-gray-900 rounded"></div>
            <div className="mt-2 w-8/12 h-3 bg-gray-900 rounded"></div>
          </div>

          <div className="grid grid-cols-2 mt-5 gap-x-2 gap-y-1">
            <div className="mt-2 w-full h-3 bg-gray-900 rounded"></div>
            <div className="mt-2 w-full h-3 bg-gray-900 rounded"></div>
            <div className="mt-2 w-full h-3 bg-gray-900 rounded"></div>
            <div className="mt-2 w-full h-3 bg-gray-900 rounded"></div>
          </div>
          ...
          <div className="flex items-center mt-5">
            <div>
              <div className="rounded-full bg-gray-900 w-10 h-10"></div>
            </div>
